...
import static Frames.q4.Q4b.text;
import Frames.welcome.Welcomegirlna;
 ...
 * @author Momen
 */
public class Q5g extends javax.swing.JFrame {
        ...
        if (s.insertanswer(a)) {
            ...
            try {
                while (rs.next()) {
                    ...
                    if (grade >=4) {
                        Welcomegirlpo q = new Welcomegirlpo();
                        q.setVisible(true);
                        this.dispose();
                    }else if (grade<4) {
                        Welcomegirlna q = new Welcomegirlna();
                        q.setVisible(true);
                        this.dispose();
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Q5g.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
